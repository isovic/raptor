...
std::shared_ptr<raptor::GraphMappingResult> GraphMapper::Map(const mindex::SequencePtr& qseq,
    ...
    result->timings()["gmap_break_anchors"] = tt_break_anchors.get_msecs();
    result->timings()["gmap_align_anchors"] = tt_align_anchors.get_msecs();
    result->timings()["gmap_constr_anchor_graph"] = tt_construct_anchor_graph.get_msecs();
    result->timings()["gmap_graph_dp"] = tt_graph_dp.get_msecs();
