...
std::shared_ptr<raptor::RegionAligned> createAlignedRegion(std::shared_ptr<raptor::MappingEnv> env,
                                                       ...
                                                       int32_t region_priority, bool region_is_supplementary) {
    return std::shared_ptr<raptor::RegionAligned>(new raptor::RegionAligned(
                        env, aln, path_id, num_paths, segment_id,
                        num_segments, region_priority, region_is_supplementary));
}
