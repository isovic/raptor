...
std::shared_ptr<mindex::IndexParams> createIndexParams(int32_t _k, int32_t _w,
                                                       ...
                                                       int64_t _min_tlen) {
    return std::shared_ptr<mindex::IndexParams>(new mindex::IndexParams(
        _k, _w, _base_spacing, _hp_supp, _max_hp_len, _freq_percentile, _min_occ_cutoff, _index_only_fwd_strand, _min_tlen));
}
...
IndexParams::IndexParams(int32_t _k, int32_t _w, int32_t _base_spacing, bool _hp_supp, int32_t _max_hp_len,
