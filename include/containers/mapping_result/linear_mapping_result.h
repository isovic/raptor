...
public:
    ...
    void target_hits(const std::vector<std::shared_ptr<raptor::TargetHits<mindex::MinimizerHitPacked>>>& new_target_hits) {
    ...
    const std::vector<std::shared_ptr<raptor::TargetHits<mindex::MinimizerHitPacked>>>& target_hits() const {
        return target_hits_;
    }
    ...
    std::vector<std::shared_ptr<raptor::TargetHits<mindex::MinimizerHitPacked>>>& target_hits() {
        return target_hits_;
    }
...
private:
    ...
    std::vector<std::shared_ptr<raptor::TargetHits<mindex::MinimizerHitPacked>>> target_hits_;
