Mapping a long read to an assembly graph composed of two collapsed regions (at the front and the back) and a bubble in the middle. The bubble has 2 identical branches. The long read should span the bubble.
  $ ${BIN_DIR}/raptor -r ${PROJECT_DIR}/test-data/demos/demo-5-assembly-graph-short-bubble/ref.fasta -g ${PROJECT_DIR}/test-data/demos/demo-5-assembly-graph-short-bubble/graph.gfa2 -d ${PROJECT_DIR}/test-data/demos/demo-5-assembly-graph-short-bubble/read-1.fasta -v 0
...
Aligning a long read to an assembly graph composed of two collapsed regions (at the front and the back) and a bubble in the middle. The bubble has 2 identical branches. The long read should span the bubble.
  $ ${BIN_DIR}/raptor -r ${PROJECT_DIR}/test-data/demos/demo-5-assembly-graph-short-bubble/ref.fasta -g ${PROJECT_DIR}/test-data/demos/demo-5-assembly-graph-short-bubble/graph.gfa2 -d ${PROJECT_DIR}/test-data/demos/demo-5-assembly-graph-short-bubble/read-1.fasta -v 0 --align --out-fmt m4
  m141013_011508_sherri_c100709962550000001823135904221533_s1_p0/806/0_37037 part1 -9797 90.2137 0 214 10847 37037 0 1986 12000 12000
  m141013_011508_sherri_c100709962550000001823135904221533_s1_p0/806/0_37037 part2b -9807 90.12 0 10847 21507 37037 0 0 10000 10000
  m141013_011508_sherri_c100709962550000001823135904221533_s1_p0/806/0_37037 part3 -14182 89.1247 0 21507 37037 37037 0 0 14510 27467
