Align a synthetic spliced read to a synthetic genome + transcriptome. The synthetic read is actually spliced from real PacBio reads, and the reference is a chunk of E. Coli. The transcriptome graph annotation is fake.
  $ ${BIN_DIR}/raptor --out-fmt paf -r ${PROJECT_DIR}/test-data/demos/demo-2-transcriptome-synth/ecoli-0-100000.fasta -g ${PROJECT_DIR}/test-data/demos/demo-2-transcriptome-synth/graph.gfa2 -d ${PROJECT_DIR}/test-data/demos/demo-2-transcriptome-synth/read-1-spliced-linear.fasta -v 0
...
Align a synthetic circRNA read on the transcriptome graph with a circular edge.
  $ ${BIN_DIR}/raptor -r ${PROJECT_DIR}/test-data/demos/demo-2-transcriptome-synth/ecoli-0-100000.fasta -g ${PROJECT_DIR}/test-data/demos/demo-2-transcriptome-synth/graph.gfa2 -d ${PROJECT_DIR}/test-data/demos/demo-2-transcriptome-synth/read-2-spliced-circular.fasta -v 0 --align --out-fmt m4
